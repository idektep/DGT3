...
public class Controller_Movement_AGV : MonoBehaviour
{
    // ───────────────────────────────
    // MQTT CONFIG
    // ───────────────────────────────
    ...
    void Update()
    {
        ...
        if (moveforward)        moveVector += transform.forward;
    ...
    void HandleMessage(string msg)
    {
        ...
        // MOVE (Local)
        // ───────────────────────────────
        if (msg == "MOVE:FORWARD") { moveforward = true; moveBackward = false; Debug.Log("✈️ Move Forward"); }
        else if (msg == "MOVE:BACKWARD") { moveBackward = true; moveforward = false; Debug.Log("🔙 Move Backward"); }
        ...
        else if (msg == "MOVE:STOP")
        {
            moveforward = moveBackward = moveUp = moveDown = moveLeft = moveRight = false;
